...
public final class Messages {
    ...
    public static final Object ERR_CANNOT_CLOSE_CONNECTION = "Cannot close connection.";
    public static final Object ERR_CANNOT_CLOSE_RESULTSET = "Cannot close resultset.";
